[grid]
s0_put_center_key = <Super>Return
...
[core]
s0_active_plugins = core;composite;opengl;imgjpeg;compiztoolbox;decor;imgpng;vpswitch;expo;resize;snap;imgsvg;grid;place;text;gnomecompat;mousepoll;staticswitcher;workarounds;scale;resizeinfo;move;scaleaddon;wall;unitymtgrabhandles;
